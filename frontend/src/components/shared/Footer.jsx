      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <h2 className="text-2xl font-bold">
                Job<span className="text-[#6A38C2]">Quest</span>
              </h2>
            </div>
          ...
          <div>
            ...
            <FooterLinks links={footerLinks.company} />
          </div>
          <div>
          ...
          <div>
            ...
            <FooterLinks links={footerLinks.legal} />
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="mt-4 sm:mt-0">
              <select className="bg-white border border-gray-200 rounded-md text-sm px-3 py-1">
...
const SocialLink = ({ children, href, ...props }) => (
  <a
    href={href}
    className="text-gray-400 hover:text-[#6A38C2] transition-colors duration-200"
    target="_blank"
  ...
  <ul className="space-y-2">
    {links.map((link) => (
      <li key={link.name}>
        <Link
          to={link.href}
          className="text-gray-600 hover:text-[#6A38C2] transition-colors duration-200 text-sm"
        >
          {link.name}
        </Link>
      </li>
